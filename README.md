...
<head>
  ...
  <title>Naveen kumarPortfolio</title>
  <style>
	* {
  	margin: 0;
  	padding: 0;
...
<header style="display: flex; flex-direction: row; align-items: center; justify-content: space-between; padding: 2rem">
  ...
  <p>Naveen Kumar<br>Kaamadhenu Arts and Science College</p>
...
<section id="about" class="active">
  <h2>About Me</h2>
  <p>I'm a <b>Naveen Kumar</b> in the Department of CA and IT at KASC specializes in software development and data structures.<br>I has over 15 years of teaching experience and believes in creating a dynamic learning environment that encourages problem-solving and hands-on coding practice.</p>
</section>
...
<section id="contact">
  <h2>Contact</h2>
  <p>Email: <a href="Naveen Kumar@kascsahy.ac.in">Naveen kumar@kascsahy.ac.in</a></p>
  <p>Phone: +91-9003971776</p>
  <p>Location: sulur coimbatore</p>
  <div style="margin-top: 1rem;">
	<a href="https://linkedin.com/in/Naveen Kumar" target="_blank">LinkedIn</a> |
	<a href="https://github.com/Naveen Kumar" target="_blank">GitHub</a> |
	<a href="https://instagram.com/l2008" target="_blank">Instagram</a>
  </div>
</section>
...
<footer>
  <p>&copy; 2025 Mr.Naveen kumar: All rights reserved.</p>
</footer>
